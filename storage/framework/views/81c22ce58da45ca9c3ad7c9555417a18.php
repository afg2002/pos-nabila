                                        ...
                                        <select wire:model.live="product_id" id="product_id" 
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($product->id); ?>">
                                                    <?php echo e($product->name); ?> (<?php echo e($product->sku); ?>) - Stok: <?php echo e($product->current_stock); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        <label for="quantity" class="block text-sm font-medium text-gray-700 mb-1">
                                            <!--[if BLOCK]><![endif]--><?php if($movement_type === 'adjustment'): ?>
                                                Stok Baru *
                                            <?php else: ?>
                                                Jumlah *
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($selectedProduct && $movement_type === 'out'): ?>
                                            <p class="mt-1 text-xs text-gray-500">
                                                Stok tersedia: <?php echo e($selectedProduct->current_stock); ?>
