                    ...
                    <div class="flex-1">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['total_roles'])); ?></p>
                            </div>
                        </div>
                        <div class="mt-4 flex items-center justify-between">
                            <div class="flex items-center space-x-2">
                                <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                                <span class="text-sm text-green-600 font-semibold"><?php echo e($stats['active_roles']); ?> active</span>
                            </div>
                            <div class="flex items-center text-xs text-gray-500">
                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['total_permissions'])); ?></p>
                            </div>
                        </div>
                        <div class="mt-4 flex items-center justify-between">
                            <div class="flex items-center space-x-2">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'roles.create')): ?>
                        <a href="<?php echo e(route('roles.index')); ?>" class="group w-full flex items-center px-4 py-4 text-sm font-medium text-gray-700 bg-gradient-to-r from-green-50 to-green-100 rounded-xl hover:from-green-100 hover:to-green-200 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
            ...
            <div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
                        ...
                        <div class="px-6 py-4 hover:bg-gray-50 transition-colors duration-200">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    <div class="relative">
                                        <div class="w-12 h-12 bg-gradient-to-br from-blue-400 to-purple-500 rounded-xl flex items-center justify-center shadow-lg">
                                            <span class="text-sm font-bold text-white"><?php echo e(substr($user->name, 0, 2)); ?></span>
                                        </div>
                                        ...
                                        <div class="flex items-center space-x-2 mt-1">
                                            ...
                                            <?php if($user->roles->count() > 2): ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-gray-100 text-gray-600">
                                                    +<?php echo e($user->roles->count() - 2); ?> more
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="flex flex-col items-end space-y-1">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold <?php echo e($user->is_active ? 'bg-green-100 text-green-800 shadow-green-100' : 'bg-red-100 text-red-800 shadow-red-100'); ?> shadow-sm">
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'users.view')): ?>
                    <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-blue-50 border-t border-gray-100">
                        <a href="<?php echo e(route('users.index')); ?>" class="group flex items-center justify-center text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors duration-200">
