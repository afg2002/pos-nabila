<div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
    <div class="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 px-6 py-6 border-b border-gray-200">
        <div class="flex justify-between items-center">
            ...
            <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'users.create')): ?>
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300 group">
                        ...
                        <td class="px-6 py-5 whitespace-nowrap">
                            <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-semibold shadow-sm 
                                ...
                                <div class="w-2 h-2 rounded-full mr-2 <?php echo e($user->is_active ? 'bg-green-500 animate-pulse' : 'bg-red-500'); ?>"></div>
                        ...
                        <td class="px-6 py-5 whitespace-nowrap">
                            <div class="flex items-center text-sm text-gray-500">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs"><?php echo e($user->created_at->diffForHumans()); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-5 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'users.edit')): ?>
                                    <button wire:click="$dispatch('openUserForm', { userId: <?php echo e($user->id); ?> })" 
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'users.delete')): ?>
                                    <button wire:click="confirmDeleteUser(<?php echo e($user->id); ?>)"
                        ...
                        <td colspan="6" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-500 mb-6 max-w-sm text-center">
                                    <!--[if BLOCK]><![endif]--><?php if($search || !$showInactive): ?>
    ...
    <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-blue-50 border-t border-gray-200 rounded-b-2xl">
        <div class="flex items-center justify-between">
            <div class="text-sm text-gray-600">
                Showing <span class="font-medium"><?php echo e($users->firstItem() ?? 0); ?></span> to <span class="font-medium"><?php echo e($users->lastItem() ?? 0); ?></span> of <span class="font-medium"><?php echo e($users->total()); ?></span> users
            </div>
...
<?php /**PATH C:\laragon\www\laravel_livewire_RBAC_boilerplate\resources\views/livewire/users/user-list.blade.php ENDPATH**/ ?>