                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($movement->ref_type === 'manual'): ?>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $movement)): ?>
                                            <button wire:click="openEditModal(<?php echo e($movement->id); ?>)" 
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $movement)): ?>
                                            <button wire:click="confirmDeleteMovement(<?php echo e($movement->id); ?>)" 
                    ...
                    <form wire:submit.prevent="updateMovement" class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                                <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($selectedMovement->product->name); ?></p>
                                <p class="text-xs text-gray-500">SKU: <?php echo e($selectedMovement->product->sku); ?></p>
                            </div>
                        </div>
