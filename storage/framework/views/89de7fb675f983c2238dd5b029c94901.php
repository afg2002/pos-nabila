                ...
                <div class="mt-3">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-medium text-gray-900">
                            <?php echo e($isEditing ? 'Edit Role' : 'Create New Role'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            ...
                            <div class="border border-gray-300 rounded-md p-4 max-h-96 overflow-y-auto">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $permissionsByGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-6 last:mb-0">
                                        <div class="flex items-center justify-between mb-3">
                                            <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wide"><?php echo e(ucfirst($group)); ?> Permissions</h4>
                                            <button type="button" wire:click="selectAllInGroup('<?php echo e($group); ?>')"
                                                    class="text-xs text-blue-600 hover:text-blue-800 font-medium">
                                                <?php
                                                    $groupIds = $permissions->pluck('id')->toArray();
                                                    $allSelected = !array_diff($groupIds, $this->selectedPermissions);
                                                ?>
                                                <?php echo e($allSelected ? 'Deselect All' : 'Select All'); ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="flex items-start space-x-3 p-2 rounded-md hover:bg-gray-50">
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <span class="text-sm font-medium text-gray-900 block"><?php echo e($permission->display_name); ?></span>
                                                        <!--[if BLOCK]><![endif]--><?php if($permission->description): ?>
                                                            <p class="text-xs text-gray-500 mt-1"><?php echo e($permission->description); ?></p>
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                        <p class="text-xs text-gray-400 font-mono"><?php echo e($permission->name); ?></p>
                                                    </div>
                                                </label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" 
                                ...
                                <?php echo e($isEditing ? 'Update Role' : 'Create Role'); ?>
...
<script>
    document.addEventListener('livewire:init', () => {
        Livewire.on('openRoleForm', (event) => {
            ...
            Livewire.find('<?php echo e($this->getId()); ?>').openModal(roleId);
        });
...
<?php /**PATH C:\laragon\www\laravel_livewire_RBAC_boilerplate\resources\views/livewire/roles/role-form.blade.php ENDPATH**/ ?>