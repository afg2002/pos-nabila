<div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
    <div class="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 px-6 py-6 border-b border-gray-200">
        <div class="flex justify-between items-center">
            ...
            <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'roles.create')): ?>
        ...
        <div class="mt-6 flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0 lg:space-x-6">
            ...
            <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                <select wire:model.live="filterByPermissions" class="px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-sm font-medium transition-all duration-200">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $permissionGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($group); ?>"><?php echo e(ucfirst($group)); ?> Permissions</option>
                ...
                <tr>
                    ...
                    <th wire:click="sortBy('display_name')" class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-200 transition-colors duration-200">
                        <div class="flex items-center space-x-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($sortField === 'display_name'): ?>
                                <div class="w-4 h-4 bg-blue-100 rounded flex items-center justify-center">
                                    <svg class="w-3 h-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <!--[if BLOCK]><![endif]--><?php if($sortDirection === 'asc'): ?>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path>
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300 group">
                        <td class="px-6 py-5 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg transition-shadow duration-300">
                                    <span class="text-sm font-bold text-white"><?php echo e(substr($role->display_name, 0, 2)); ?></span>
                                </div>
                                <div>
                        ...
                        <td class="px-6 py-5 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($role->display_name); ?></div>
                        </td>
                        <td class="px-6 py-5">
                            <div class="text-sm text-gray-600 max-w-xs">
                                <p class="truncate"><?php echo e($role->description ?: 'No description provided'); ?></p>
                            </div>
                        </td>
                        <td class="px-6 py-5 whitespace-nowrap">
                        ...
                        <td class="px-6 py-5 whitespace-nowrap">
                            <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-semibold shadow-sm 
                                <?php echo e($role->is_active 
                                    ? 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-800' 
                                    : 'bg-gradient-to-r from-red-100 to-pink-100 text-red-800'); ?>">
                                <div class="w-2 h-2 rounded-full mr-2 <?php echo e($role->is_active ? 'bg-green-500 animate-pulse' : 'bg-red-500'); ?>"></div>
                        ...
                        <td class="px-6 py-5 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <!--[if BLOCK]><![endif]--><?php if($role->name !== 'super-admin'): ?>
                                    <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'roles.edit')): ?>
                                        <button wire:click="$dispatch('openRoleForm', { roleId: <?php echo e($role->id); ?> })" 
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <?php else: ?>
                                    <span class="inline-flex items-center px-3 py-2 text-xs font-semibold text-gray-500 bg-gray-100 rounded-lg cursor-not-allowed">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($role->name !== 'super-admin'): ?>
                                    <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'roles.edit')): ?>
                                        <button wire:click="toggleRoleStatus(<?php echo e($role->id); ?>)" 
                                            ...
                                            <svg class="w-4 h-4 mr-1.5 group-hover/btn:rotate-180 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <!--[if BLOCK]><![endif]--><?php if($role->is_active): ?>
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728L5.636 5.636m12.728 12.728L18.364 5.636M5.636 18.364l12.728-12.728"></path>
                                                <?php else: ?>
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </svg>
                                            <?php echo e($role->is_active ? 'Deactivate' : 'Activate'); ?>

                                        </button>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'roles.delete')): ?>
                                        <button 
                                            wire:click="confirmDeleteRole(<?php echo e($role->id); ?>)"
                        ...
                        <td colspan="7" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-500 mb-6 max-w-sm text-center">
                                    <!--[if BLOCK]><![endif]--><?php if($search || $filterByPermissions || !$showInactive): ?>
                                        Try adjusting your search or filter criteria to find what you're looking for.
                                    <?php else: ?>
                                        Get started by creating your first role to manage system permissions.
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </p>
                                <!--[if BLOCK]><![endif]--><?php if(!$search && !$filterByPermissions): ?>
                                    <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'roles.create')): ?>
    ...
    <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-blue-50 border-t border-gray-200 rounded-b-2xl">
        <div class="flex items-center justify-between">
            <div class="text-sm text-gray-600">
                Showing <span class="font-medium"><?php echo e($roles->firstItem() ?? 0); ?></span> to <span class="font-medium"><?php echo e($roles->lastItem() ?? 0); ?></span> of <span class="font-medium"><?php echo e($roles->total()); ?></span> roles
            </div>
...
<?php /**PATH C:\laragon\www\laravel_livewire_RBAC_boilerplate\resources\views/livewire/roles/role-list.blade.php ENDPATH**/ ?>