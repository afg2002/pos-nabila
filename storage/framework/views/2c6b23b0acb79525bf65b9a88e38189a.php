...
<head>
    ...
    <title>Login - <?php echo e(config('app.name', 'Laravel Boilerplate')); ?></title>
        ...
        <div class="max-w-md w-full space-y-8 slide-up">
            ...
            <div class="text-center">
                ...
                <p class="text-blue-100">
                    Sign in to <?php echo e(config('app.name', 'Laravel Boilerplate')); ?>
                ...
                <form class="space-y-6" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <div class="text-sm">
                                <a href="<?php echo e(route('password.request')); ?>" class="font-medium text-blue-600 hover:text-blue-500 transition duration-150 ease-in-out">
                                    Forgot password?
                                </a>
                            </div>
                        <?php endif; ?>
            ...
            <div class="text-center">
                <p class="text-xs text-blue-100">
                    © <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Laravel Boilerplate')); ?>. All rights reserved.
                </p>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH C:\laragon\www\pos-nabila\resources\views/auth/login.blade.php ENDPATH**/ ?>