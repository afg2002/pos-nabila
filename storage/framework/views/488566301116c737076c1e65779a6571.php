...
<div class="pos-two-column">
    ...
    <div class="pos-products-section">
        ...
        <div class="flex items-center justify-between mb-4 gap-3 flex-wrap">
            ...
            <div class="flex items-center gap-3">
                <div class="text-sm text-gray-600 flex items-center gap-2">
                    ...
                    <?php echo e($activeWarehouseName ?? 'Gudang'); ?>
            ...
            <div class="relative flex-1 md:block lg:block"
                 x-data="{
                      ...
                      get shouldShowResults() {
                          return this.searchHasFocus && '<?php echo e($productSearch); ?>' !== '' && window.innerWidth <= 1024;
                      },
                      handleKeydown(e) {
                          const productsData = <?php echo \Illuminate\Support\Js::from($products->take(5)->map(function($p) {
                              return [
                                  'id' => $p->id,
                                  'name' => $p->name,
                ...
                <div x-show="shouldShowResults"
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($products->count() > 0): ?>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $stock = $product->warehouseStocks->first()?->stock_on_hand ?? 0;
                            ?>
                            <div class="search-result-item"
                                 :class="{ 'highlighted': highlightedIndex === <?php echo e($index); ?> }"
                                 @mouseenter="highlightedIndex = <?php echo e($index); ?>"
                                 @click="
                                     $store.transactions.addProduct({
                                         id: <?php echo e($product->id); ?>,
                                         name: '<?php echo e(addslashes($product->name)); ?>',
                                         priceRetail: <?php echo e($product->price_retail); ?>,
                                         priceSemiGrosir: <?php echo e($product->price_semi_grosir ?? $product->price_retail); ?>,
                                         priceGrosir: <?php echo e($product->price_grosir ?? $product->price_retail); ?>,
                                         stock: <?php echo e($stock); ?>
                                ...
                                <div class="search-result-info">
                                    <div class="search-result-name"><?php echo e($product->name); ?></div>
                                    <div class="search-result-price">Rp <?php echo e(number_format($product->price_retail, 0, ',', '.')); ?></div>
                                    <div class="search-result-sku">SKU: <?php echo e($product->sku); ?> • Stok: <?php echo e($stock); ?></div>
                                </div>
        ...
        <div class="products-scroll-area">
            ...
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="product-compact"
                    ...
                    <div class="product-info">
                        ...
                        <p class="product-price">Rp <?php echo e(number_format($product->price_retail, 0, ',', '.')); ?></p>
                        <span class="stock-badge <?php echo e($stockClass); ?>"><?php echo e($stockText); ?></span>
                    </div>
            ...
            <!--[if BLOCK]><![endif]--><?php if($hasMoreProducts && $products->count() > 0): ?>
        ...
        <div class="product-grid hidden lg:grid">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div x-data="{
                     ...
                     class="product-card">
                    <!-- Stock Badge -->
                    <span class="stock-badge-desktop <?php echo e($stockClass); ?>"><?php echo e($stockText); ?></span>
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 mb-2">SKU: <?php echo e($product->sku); ?></p>
...
<nav class="bottom-nav">
    ...
    <a href="<?php echo e(route('kasir.management')); ?>" class="nav-item">
    ...
    <div class="bg-white rounded-2xl p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div class="mb-4">
            ...
            <div class="grid grid-cols-2 gap-2">
                <button wire:click="$set('paymentMethod', 'cash')"
                        class="p-3 border-2 rounded-lg text-center <?php echo e($paymentMethod == 'cash' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'); ?>">
                    <i class="fas fa-money-bill-wave text-2xl mb-1 <?php echo e($paymentMethod == 'cash' ? 'text-blue-600' : 'text-gray-400'); ?>"></i>
                    <p class="text-sm font-medium">Tunai</p>
                </button>
                <button wire:click="$set('paymentMethod', 'transfer')"
                        class="p-3 border-2 rounded-lg text-center <?php echo e($paymentMethod == 'transfer' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'); ?>">
                    <i class="fas fa-exchange-alt text-2xl mb-1 <?php echo e($paymentMethod == 'transfer' ? 'text-blue-600' : 'text-gray-400'); ?>"></i>
                    <p class="text-sm font-medium">Transfer</p>
                </button>
                <button wire:click="$set('paymentMethod', 'edc')"
                        class="p-3 border-2 rounded-lg text-center <?php echo e($paymentMethod == 'edc' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'); ?>">
                    <i class="fas fa-credit-card text-2xl mb-1 <?php echo e($paymentMethod == 'edc' ? 'text-blue-600' : 'text-gray-400'); ?>"></i>
                    <p class="text-sm font-medium">EDC/Kartu</p>
                </button>
                <button wire:click="$set('paymentMethod', 'qr')"
                        class="p-3 border-2 rounded-lg text-center <?php echo e($paymentMethod == 'qr' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'); ?>">
                    <i class="fas fa-qrcode text-2xl mb-1 <?php echo e($paymentMethod == 'qr' ? 'text-blue-600' : 'text-gray-400'); ?>"></i>
        ...
        <div class="bg-blue-50 rounded-lg p-4 mb-4">
            ...
            <div class="flex justify-between">
                ...
                <span class="font-bold text-<?php echo e($change >= 0 ? 'green' : 'red'); ?>-600">
...
<!-- Receipt Modal -->
<!--[if BLOCK]><![endif]--><?php if($lastSale): ?>
<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60]"
     x-data="{ showReceiptModal: <?php if ((object) ('showReceiptModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showReceiptModal'->value()); ?>')<?php echo e('showReceiptModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showReceiptModal'); ?>')<?php endif; ?> }"
        ...
        <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4 mb-4">
            <div class="flex justify-between items-center mb-2">
                ...
                <span class="text-2xl font-bold text-blue-600">
                    Rp <?php echo e(number_format($lastSale->final_total, 0, ',', '.')); ?>

                </span>
            </div>
            <div class="flex justify-between text-sm text-gray-600">
                <span><?php echo e($lastSale->saleItems->count()); ?> item</span>
                <span><?php echo e($lastSale->created_at->format('d/m/Y H:i')); ?></span>
            </div>
        </div>

        <!-- Action Buttons -->
        <div class="grid grid-cols-2 gap-2 mb-3">
            <button wire:click="printReceiptThermal(<?php echo e($lastSale->id); ?>)"
            ...
            <button wire:click="exportReceiptPNG(<?php echo e($lastSale->id); ?>)"
            ...
            <button wire:click="exportReceiptPDFThermal(<?php echo e($lastSale->id); ?>)"
            ...
            <button wire:click="exportInvoiceA4(<?php echo e($lastSale->id); ?>)"
...
<!--[if BLOCK]><![endif]--><?php if($lastSale): ?>
    ...
    <div id="print-receipt-area" class="hidden">
        <div class="receipt-paper">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $itemChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageIndex => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="receipt-page">
                    <div class="text-center mb-4">
                        <h2 class="text-xl font-bold"><?php echo e(config('app.name', 'TOKO')); ?></h2>
                        <p class="text-sm">
                            Struk Pembayaran
                            <!--[if BLOCK]><![endif]--><?php if($totalPages > 1): ?>
                                &middot; Hal <?php echo e($pageIndex + 1); ?>/<?php echo e($totalPages); ?>

                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </p>
                        <p class="text-xs"><?php echo e($lastSale->created_at->format('d/m/Y H:i:s')); ?></p>
                    </div>

                    <!--[if BLOCK]><![endif]--><?php if($pageIndex === 0): ?>
                        <div class="border-t border-b border-dashed py-2 mb-2">
                            <table class="w-full text-sm">
                                <tr>
                                    <td>No. Transaksi</td>
                                    <td class="text-right"><?php echo e($lastSale->sale_number); ?></td>
                                </tr>
                                <tr>
                                    <td>Kasir</td>
                                    <td class="text-right"><?php echo e($lastSale->cashier->name ?? 'System'); ?></td>
                                </tr>
                                <!--[if BLOCK]><![endif]--><?php if($lastSale->customer_name): ?>
                                    <tr>
                                        <td>Pelanggan</td>
                                        <td class="text-right"><?php echo e($lastSale->customer_name); ?></td>
                                    </tr>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </table>
                        </div>
                    <?php else: ?>
                        <div class="border-t border-b border-dashed py-2 mb-2 text-xs text-center text-gray-500">
                            Halaman <?php echo e($pageIndex + 1); ?> / <?php echo e($totalPages); ?>

                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                    <div class="mb-2 space-y-1">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div>
                                <div class="font-medium"><?php echo e(optional($item->product)->name ?? ($item->custom_item_name ?? 'Item')); ?></div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($pageIndex === $totalPages - 1): ?>
                        <div class="border-t border-dashed pt-2 mt-3">
                            <table class="w-full text-sm">
                                <tr>
                                    <td>Subtotal</td>
                                    <td class="text-right">Rp <?php echo e(number_format($lastSale->subtotal, 0, ',', '.')); ?></td>
                                </tr>
                                <!--[if BLOCK]><![endif]--><?php if($lastSale->discount_total > 0): ?>
                                    <tr>
                                        <td>Diskon</td>
                                        <td class="text-right text-red-600">-Rp <?php echo e(number_format($lastSale->discount_total, 0, ',', '.')); ?></td>
                                    </tr>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <tr class="font-bold text-base">
                                    <td>TOTAL</td>
                                    <td class="text-right">Rp <?php echo e(number_format($lastSale->final_total, 0, ',', '.')); ?></td>
                                </tr>
                                <tr>
                                    <td>Bayar (<?php echo e(ucfirst($lastSale->payment_method)); ?>)</td>
                                    <td class="text-right">Rp <?php echo e(number_format(($lastSale->cash_amount ?? 0) + ($lastSale->qr_amount ?? 0) + ($lastSale->edc_amount ?? 0), 0, ',', '.')); ?></td>
                                </tr>
                                <tr>
                                    <td>Kembalian</td>
                                    <td class="text-right">Rp <?php echo e(number_format($lastSale->change_amount, 0, ',', '.')); ?></td>
                                </tr>
                            </table>
...
<?php /**PATH C:\laragon\www\laravel_livewire_RBAC_boilerplate\resources\views/livewire/pos-responsive.blade.php ENDPATH**/ ?>