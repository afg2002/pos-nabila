                                ...
                                <!--[if BLOCK]><![endif]--><?php if(isset($day['agendas']) && count($day['agendas']) > 0): ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $displayedAgendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="text-xs p-1.5 rounded-md cursor-pointer transition-all duration-200 hover:shadow-sm border
                                             ...
                                             wire:click.stop="selectDate('<?php echo e($day['date']); ?>')">
                                            <div class="font-medium truncate text-xs"><?php echo e(Str::limit($agenda->effective_supplier_name, 12)); ?></div>
                                            <div class="opacity-80 truncate text-xs"><?php echo e(Str::limit($agenda->is_simplified ? 'Barang Various' : ($agenda->goods_name ?? $agenda->item_name ?? 'Barang'), 12)); ?></div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($agenda->effective_supplier_name); ?></div>
                                    <div class="text-sm text-green-600 font-medium">
                                        <?php echo e($agenda->is_simplified ? 'Barang Various (Input Sederhana)' : ($agenda->goods_name ?? $agenda->item_name)); ?>

                                        <!--[if BLOCK]><![endif]--><?php if($agenda->is_simplified): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <div class="font-medium">Rp <?php echo e(number_format($agenda->effective_total_amount, 0, ',', '.')); ?></div>
                ...
                <div class="mt-3">
                    ...
                    <form wire:submit="save">
                        ...
                        <div class="mb-6">
                            <div class="flex bg-gray-100 rounded-lg p-1">
                                <button type="button"
                                        class="flex-1 px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 <?php echo e($input_mode === 'simplified' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'); ?>"
                                ...
                                <button type="button"
                                        class="flex-1 px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 <?php echo e($input_mode === 'detailed' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'); ?>"
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="number"
                                               ...
                                               step="0.01"
                                               required>
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['total_quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
                ...
                <div class="mt-3">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($selectedAgenda): ?>
                        <div class="mb-4 p-4 bg-gray-50 rounded-lg">
                            <p class="text-sm text-gray-600">Supplier: <span class="font-medium"><?php echo e($selectedAgenda->effective_supplier_name); ?></span></p>
                            <p class="text-sm text-gray-600">Item: <span class="font-medium"><?php echo e($selectedAgenda->is_simplified ? 'Barang Various (Input Sederhana)' : $selectedAgenda->goods_name); ?></span></p>
                            <!--[if BLOCK]><![endif]--><?php if($selectedAgenda->is_simplified): ?>
                                <p class="text-sm text-gray-600">Total Barang: <span class="font-medium"><?php echo e($selectedAgenda->effective_quantity); ?> <?php echo e($selectedAgenda->effective_unit); ?></span></p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <p class="text-sm text-gray-600">Total: <span class="font-medium">Rp <?php echo e(number_format($selectedAgenda->effective_total_amount, 0, ',', '.')); ?></span></p>
                            <p class="text-sm text-gray-600">Sudah Dibayar: <span class="font-medium">Rp <?php echo e(number_format($selectedAgenda->paid_amount, 0, ',', '.')); ?></span></p>
                            <p class="text-sm text-gray-600">Sisa: <span class="font-medium text-red-600">Rp <?php echo e(number_format($selectedAgenda->remaining_amount, 0, ',', '.')); ?></span></p>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01"
                                       min="0.01"
                                       max="<?php echo e($selectedAgenda ? $selectedAgenda->remaining_amount : 0); ?>"
...
<?php /**PATH C:\laragon\www\laravel_livewire_RBAC_boilerplate\resources\views/livewire/incoming-goods-agenda-management.blade.php ENDPATH**/ ?>