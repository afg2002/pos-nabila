        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden lg:flex items-center space-x-4">
                    <a href="<?php echo e(route('login')); ?>" class="btn-primary text-white px-6 py-3 rounded-full font-semibold shadow-lg">
                        Masuk Sistem
                    </a>
        ...
        <div class="p-6">
            ...
            <nav class="space-y-4">
                ...
                <div class="pt-4 border-t border-gray-200">
                    <a href="<?php echo e(route('login')); ?>" class="btn-primary text-white px-6 py-3 rounded-full font-semibold shadow-lg w-full text-center">
                        Masuk Sistem
                    </a>
                </div>
            </nav>
...
<?php /**PATH C:\laragon\www\laravel_livewire_RBAC_boilerplate\resources\views/welcome.blade.php ENDPATH**/ ?>