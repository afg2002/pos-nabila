            ...
            <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-blue-900"><?php echo e(number_format($stockSummary['total_products'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-green-50 rounded-lg p-4 border border-green-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-green-900"><?php echo e(number_format($stockSummary['total_stock'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-yellow-900"><?php echo e(number_format($stockSummary['low_stock'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-red-50 rounded-lg p-4 border border-red-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-red-900"><?php echo e(number_format($stockSummary['out_of_stock'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-purple-50 rounded-lg p-4 border border-purple-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-purple-900">Rp <?php echo e(number_format($stockSummary['total_value'], 0, ',', '.')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
</div><?php /**PATH C:\laragon\www\pos-nabila\resources\views/livewire/warehouse-stock-view.blade.php ENDPATH**/ ?>