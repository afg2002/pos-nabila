    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Ringkasan Omset Bulanan</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Total omset perbulan dengan breakdown ecer dan grosir</p>
                </div>
                <div class="text-right">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ Carbon::now()->format('F Y') }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-blue-600 dark:text-blue-300">Total Omset Bulanan</p>
                            <p class="text-2xl font-bold text-blue-900 dark:text-blue-100">Rp {{ number_format($monthlyTotalRevenue, 0, ',', '.') }}</p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900 dark:to-green-800 rounded-lg p-4 border border-green-200 dark:border-green-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-green-600 dark:text-green-300">Omset Ecer Bulanan</p>
                            <p class="text-2xl font-bold text-green-900 dark:text-green-100">Rp {{ number_format($monthlyEcerRevenue, 0, ',', '.') }}</p>
                            <p class="text-xs text-green-600 dark:text-green-400">{{ number_format($monthlyEcerCount) }} transaksi</p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900 dark:to-purple-800 rounded-lg p-4 border border-purple-200 dark:border-purple-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-purple-600 dark:text-purple-300">Omset Grosir Bulanan</p>
                            <p class="text-2xl font-bold text-purple-900 dark:text-purple-100">Rp {{ number_format($monthlyGrosirRevenue, 0, ',', '.') }}</p>
                            <p class="text-xs text-purple-600 dark:text-purple-400">{{ number_format($monthlyGrosirCount) }} transaksi</p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-emerald-50 to-emerald-100 dark:from-emerald-900 dark:to-emerald-800 rounded-lg p-4 border border-emerald-200 dark:border-emerald-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-emerald-600 dark:text-emerald-300">Keuntungan Kotor Bulanan</p>
                            <p class="text-2xl font-bold text-emerald-900 dark:text-emerald-100">Rp {{ number_format($monthlyGrossProfit, 0, ',', '.') }}</p>
                            <p class="text-xs text-emerald-600 dark:text-emerald-400">{{ number_format($monthlyGrossProfitMargin, 2) }}% margin</p>
                        </div>
            ...
            <div class="mt-6 bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Total Ecer + Grosir</p>
                        <p class="text-lg font-semibold text-gray-900 dark:text-white">Rp {{ number_format($monthlyEcerRevenue + $monthlyGrosirRevenue, 0, ',', '.') }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Total Transaksi</p>
                        <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ number_format($monthlyEcerCount + $monthlyGrosirCount) }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Rata-rata Nilai Transaksi</p>
                        <p class="text-lg font-semibold text-gray-900 dark:text-white">
                            Rp {{ number_format(($monthlyEcerRevenue + $monthlyGrosirRevenue) / max($monthlyEcerCount + $monthlyGrosirCount, 1), 0, ',', '.') }}
                        </p>
                    </div>
                </div>
            </div>
