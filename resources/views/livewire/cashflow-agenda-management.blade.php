        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($totalPayment, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
                    ...
                    @forelse($agendas as $agenda)
                        <tr class="hover:bg-gray-50">
                           <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                Rp {{ number_format($agenda->total_ecer, 0, ',', '.') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                Rp {{ number_format($agenda->total_grosir, 0, ',', '.') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                Rp {{ number_format($agenda->grosir_cash_hari_ini, 0, ',', '.') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                Rp {{ number_format($agenda->qr_payment_amount, 0, ',', '.') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                Rp {{ number_format($agenda->edc_payment_amount, 0, ',', '.') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium {{ $agenda->net_cashflow >= 0 ? 'text-green-600' : 'text-red-600' }}">
                                Rp {{ number_format($agenda->net_cashflow, 0, ',', '.') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                @if($agenda->has_purchase_orders)
                                    <div class="space-y-1">
                                        <div class="font-medium text-green-600">{{ $agenda->formatted_total_purchase_order_profit }}</div>
                                        <div class="text-xs text-gray-600">Margin: {{ $agenda->formatted_average_purchase_order_margin }}</div>
                                        <div class="text-xs text-blue-600">{{ $agenda->purchase_order_count }} PO</div>
                ...
                <div class="mt-3">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium text-gray-900">
                            {{ $editingId ? 'Edit Agenda Cashflow' : 'Tambah Agenda Cashflow' }}
                        </h3>
                    ...
                    <form wire:submit.prevent="saveAgenda">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                @error('total_ecer') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('total_grosir') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('grosir_cash_hari_ini') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('qr_payment_amount') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('edc_payment_amount') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('capitalTrackingId') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
